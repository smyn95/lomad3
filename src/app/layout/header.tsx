...
export default function Header() {
    ...
    return (
        <header className="fixed px-5 w-full h-14 z-10 top-0 left-0 xl:px-20 xl:h-max xl:bg-primaryWhite xl:max-w-[1920px] xl:relative xl:border-b border-gray-30">
            <div className='flex justify-between items-center xl:h-[100px] w-full h-full'>
                <span className="min-w-[8.4375rem]">
                    <Image src="/img-lomad-logo.svg" width={60} height={18} alt="로고" className='xl:w-[100px]'/>
                </span>
                <input type="search" className='hidden xl:block bg-transparent'/>

                <section className="flex justify-end gap-3 xl:gap-5">
                    <button name="로그인" className='hidden xl:block'>
                    ...
                    <button name="검색" className='xl:hidden'>
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button name="유저" className='hidden xl:block'>
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <section className='hidden h-[78px] w-full uppercase xl:flex justify-center text-body2 relative items-center peer'>
            ...
            <section className='absolute w-full bg-primaryWhite left-1/2 -translate-x-1/2 min-h-[494px] z-20 h-full justify-center border-t border-gray-30 xl:peer-hover:flex transition-all hidden hover:flex'>
                ...
                <div className='w-[304px] h-full p-7'>
                    ...
                    <ul className='flex gap-2 rounded-md mt-8'>
